...
{
    public class CreateMetaCommand : IRequest<SuccessServiceResponse<Guid>>
    {
        public String Name { get; set; }
        public String Content { get; set; }
        public Guid PageId { get; set; }

        public class CreateMetaCommandHandler : IRequestHandler<CreateMetaCommand,SuccessServiceResponse<Guid>>
        {
            ...
            public async Task<SuccessServiceResponse<Guid>> Handle(CreateMetaCommand request, CancellationToken cancellationToken)
            {
